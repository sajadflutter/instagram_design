# Instagram Design Project

A This project is a redesign of the Instagram mobile app interface. The goal of this project is to create a more user-friendly and aesthetically pleasing interface for the popular social media platform.
...
command:
git clone https://github.com/sajadflutter/instagram_design.git
